...
def get_post_fudge_factor(prior_high_mass):
    ...
    m_final, spin_final = get_final_from_initial(
        mass1=prior_high_mass, mass2=prior_high_mass, spin1z=0.99, spin2z=0.99
    )
    post_fudge_factor = (
...
class Default:
    ...
    psd_est_segment_length = 36.0  # in seconds
    psd_est_segment_stride = 18.0  # in seconds
...
class DefaultOTF:
    ...
    _longest_wavelen = get_imr_chirp_time(
    ...
    better_distance_distribution = True
