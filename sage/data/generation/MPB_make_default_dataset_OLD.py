...
class GenerateData:
    ...
    def worker(self, idx, queues=None, qidx=None, save_idx=None):
        ...
        if not is_waveform:
            ...
            print('\n')
            print(h_plus.get_sample_times()[-1] - h_plus.get_sample_times()[0])
            print('REVIEWED')
            ...
            print('interval diff = {}'.format(end_interval - start_interval))
