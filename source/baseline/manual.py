...
def loss_and_accuracy_curves(filepath, export_dir, best_epoch=-1):
    ...
    if best_epoch != -1:
        ax.scatter(epochs[best_epoch], training_loss, marker='*', s=20.0, c='k')
        ax.scatter(epochs[best_epoch], validation_loss, marker='*', s=20.0, c='k')
    ...
    if best_epoch != -1:
        ax.scatter(epochs[best_epoch], training_accuracy, marker='*', s=20.0, c='k')
        ax.scatter(epochs[best_epoch], validation_accuracy, marker='*', s=20.0, c='k')
