...
"""
Filename        = Foobar.py
Description     = Program to plot the output of evaluate.py.

Created on Mon Aug  8 10:29:25 2022
...
Documentation: ./sensitivity_plot.py --files path1 path2 ... --output outpath
