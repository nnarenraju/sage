...
class NoiseGenerator(object):
    ...
    def __init__(self, delta_f=0.04,
    ...
    def __call__(self, start, end, seed, asd):
        return self.get(start, end, seed, asd)
    
    
    def get(self, start, end, seed, asd):
        # Get noise PSD data
        ret = {}
