...
def res2net50_v1b(pretrained=False, num_classes=1, **kwargs):
...
def res2net101_v1b(pretrained=False, num_classes=1, **kwargs):
...
def res2net152_v1b_26w_4s(pretrained=False, num_classes=1, **kwargs):
    """Constructs a Res2Net-50_v1b_26w_4s model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = Res2Net(Bottle2neck, [3, 8, 36, 3], baseWidth = 26, scale = 4, num_classes=num_classes, **kwargs)
    return model
