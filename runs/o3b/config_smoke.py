...
class O3bCFG:
    ...
    num_epochs = 2                    # SMOKE: 2 epochs (mine ep0, use ep1)
    mine_schedule = [0]               # SMOKE: mine at epoch 0 only
    keep_threshold_raw = -5.0         # SMOKE: keep from an undertrained model
    mine_iters = 60                   # SMOKE: fast mine
    bank_dir = "/work/nagarajan/hard_mining_test"   # throwaway bank
    training_iterations = 100                          # SMOKE: tiny epoch
    validation_iterations = 40                         # SMOKE
