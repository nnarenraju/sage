...
"""O3b HLV search -- thin wrapper; all settings live in config_base.py.

Searched with the O3a-trained HLV network, which is the out-of-domain pairing
...
def get_spec():
    """The O3b HLV campaign specification."""
    return search_spec(
        observing_run="O3b",
        detectors=['H1', 'L1', 'V1'],
    )
