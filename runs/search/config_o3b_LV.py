...
"""O3b LV search -- thin wrapper; all settings live in config_base.py.

Searched with the O3a-trained LV network, which is the out-of-domain pairing
...
def get_spec():
    """The O3b LV campaign specification."""
    return search_spec(
        observing_run="O3b",
        detectors=['L1', 'V1'],
    )
