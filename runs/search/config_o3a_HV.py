...
"""O3a HV search -- thin wrapper; all settings live in config_base.py.

Searched with the O3b-trained HV network, which is the out-of-domain pairing
...
def get_spec():
    """The O3a HV campaign specification."""
    return search_spec(
        observing_run="O3a",
        detectors=['H1', 'V1'],
    )
